...
.. glossary::
    ...
    `Server </projects/server/en/5.2>`_
        The main application.

    `Desktop Client </projects/client-desktop/en/5.2>`_
        The application to connect to the server.

    `Scripting Client </projects/client-library/en/5.2>`_
...
.. glossary::
    ...
    `GIS </projects/backend-gis/en/5.2>`_
        Adds GIS support.
...
.. glossary::
    ...
    `Banking </projects/modules-bank/en/5.2>`_
    ...
    `Country </projects/modules-country/en/5.2>`_
        ISO 3166 list of countries and subdivisions.

    `Currency </projects/modules-currency/en/5.2>`_
        ISO 4217 list of currencies.

    `Customs </projects/modules-customs/en/5.2>`_
        Defines customs duty per tariff code.

    `Dashboard </projects/modules-dashboard/en/5.2>`_
        Customized dashboard.

    `Google Maps </projects/modules-google-maps/en/5.2>`_
    ...
    `Notification Email </projects/modules-notification-email/en/5.2>`_
        Sends email.

    `User Role </projects/modules-user-role/en/5.2>`_
