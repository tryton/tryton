...
Sao.PYSON.PYSON.eval = function(value, context) {
    throw 'NotImplementedError';
};

Sao.PYSON.Encoder = Class(Object, {
...
Sao.PYSON.Decoder = Class(Object, {
    ...
    decode: function(str) {
        var reviver = function(k, v) {
            if (typeof v == 'object') {
                ...
                if (cls) {
                    return cls.eval(v, this.__context);
                }
            }
            return v;
        };
...
Sao.PYSON.Eval = Class(Sao.PYSON.PYSON, {
...
Sao.PYSON.Eval.eval = function(value, context) {
...
Sao.PYSON.Not = Class(Sao.PYSON.PYSON, {
    init: function(value) {
        Sao.PYSON.Not._super.init.call(this);
        if (value instanceof Sao.PYSON.PYSON) {
            if ((jQuery(value.types()).not(['boolean']).length != 0) ||
                (jQuery(['boolean']).not(value.types()).length != 0)) {
...
Sao.PYSON.Not.eval = function(value, context) {
    return !value.v;
};

Sao.PYSON.Bool = Class(Sao.PYSON.PYSON, {
    init: function(value) {
...
Sao.PYSON.Bool.eval = function(value, context) {
...
Sao.PYSON.And = Class(Sao.PYSON.PYSON, {
    init: function(statements) {
        Sao.PYSON.And._super.init.call(this);
        for (var i = 0, len = statements.length; i < len; i++) {
            var statement = statements[i];
            if (statement instanceof Sao.PYSON.PYSON) {
                if ((jQuery(statement.types()).not(['boolean']).length != 0) ||
                    (jQuery(['boolean']).not(statement.types()).length != 0)) {
...
Sao.PYSON.And.eval = function(value, context) {
    var result = true;
...
Sao.PYSON.Or = Class(Sao.PYSON.And, {
    pyson: function() {
...
Sao.PYSON.Or.eval = function(value, context) {
    var result = false;
    for (var i = 0, len = value.s.length; i < len; i++) {
        var statement = value.s[i];
        result = result || statement;
...
Sao.PYSON.Equal = Class(Sao.PYSON.PYSON, {
    init: function(statement1, statement2) {
        Sao.PYSON.Equal._super.init.call(this);
        if (statement1 instanceof Sao.PYSON.PYSON) {
            var types1 = statement1.types();
        } else {
            var types1 = [typeof statement1];
        }
        if (statement2 instanceof Sao.PYSON.PYSON) {
            var types2 = statement2.types();
        } else {
            var types2 = [typeof statement2];
        }
        if ((jQuery(types1).not(types2).length != 0) ||
            (jQuery(types2).not(types1).length != 0)) {
...
Sao.PYSON.Equal.eval = function(value, context) {
    return value.s1 == value.s2;
};

Sao.PYSON.Greater = Class(Sao.PYSON.PYSON, {
    init: function(statement1, statement2, equal) {
        ...
        for (var i = 0; i < 2; i++) {
            var statement = statements[i];
            if (statement instanceof Sao.PYSON.PYSON) {
                if (jQuery(statement).not([int, float]).length != 0) {
        ...
        if (equal instanceof Sao.PYSON.PYSON) {
            if ((jQuery(equal.types()).not(['boolean']).length != 0) ||
                (jQuery(['boolean']).not(equal.types()).length != 0)) {
...
Sao.PYSON.Greater.eval = function(value, context) {
...
Sao.PYSON.Less = Class(Sao.PYSON.Greater, {
    pyson: function() {
...
Sao.PYSON.Less.eval = function(value, context) {
...
Sao.PYSON.If = Class(Sao.PYSON.PYSON, {
    init: function(condition, then_statement, else_statement) {
        ...
        if (condition instanceof Sao.PYSON.PYSON) {
            if ((jQuery(condition.types()).not(['boolean']).length != 0) ||
                (jQuery(['boolean']).not(condition.types()).length != 0)) {
        ...
        if (then_statement instanceof Sao.PYSON.PYSON) {
            var then_types = then_statement.types();
        } else {
            var then_types = [typeof then_statement];
        }
        if (else_statement === undefined) {
            else_statement = null;
        }
        if (else_statement instanceof Sao.PYSON.PYSON) {
            var else_types = else_statement.types();
        } else {
            var else_types = [typeof else_statement];
        }
        if ((jQuery(then_types).not(else_types).length != 0) ||
            (jQuery(else_types).not(then_types).length != 0)) {
...
Sao.PYSON.If.eval = function(value, context) {
    if (value.c) {
        return value.t;
    } else {
        return value.e;
...
Sao.PYSON.Get = Class(Sao.PYSON.PYSON, {
    init: function(obj, key, default_) {
        ...
        if (obj instanceof Sao.PYSON.PYSON) {
            if ((jQuery(obj.types()).not(['object']).length != 0) ||
                (jQuery(['object']).not(obj.types()).length != 0)) {
        ...
        if (key instanceof Sao.PYSON.PYSON) {
            if ((jQuery(key.types()).not(['string']).length != 0) ||
                (jQuery(['string']).not(key.types()).length != 0)) {
...
Sao.PYSON.Get.eval = function(value, context) {
...
Sao.PYSON.In = Class(Sao.PYSON.PYSON, {
    init: function(key, obj) {
        Sao.PYSON.In._super.init.call(this);
        if (key instanceof Sao.PYSON.PYSON) {
            if (jQuery(key.types()).not(['string', 'number']).length != 0) {
...
Sao.PYSON.In.eval = function(value, context) {
    if (value.v.indexOf) {
...
Sao.PYSON.Date = Class(Sao.PYSON.PYSON, {
...
Sao.PYSON.Date.eval = function(value, context) {
    var date = new Date();
    date.setHours(0);
    date.setMinutes(0);
    date.setSeconds(0);
...
Sao.PYSON.DateTime = Class(Sao.PYSON.Date, {
...
Sao.PYSON.DateTime.eval = function(value, context) {
    var date = new Date();
    if (value.y) date.setFullYear(value.y);
    if (value.M) date.setMonth(value.M);
    if (value.d) date.setDate(value.d);
