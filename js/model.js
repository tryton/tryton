...
Sao.Group = function(model, context, array) {
    ...
    array.load = function(ids) {
        ...
        var record_removed = [];
        for (var i = 0, len = this.record_removed.length; i < len; i++) {
            var record = this.record_removed[i];
        ...
        var record_deleted = [];
        for (var i = 0, len = this.record_deleted.length; i < len; i++) {
            var record = thos.record_deleted[i];
            if (ids.indexOf(record.id) < 0) {
    ...
    array.new = function(default_, id) {
...
Sao.field.Selection = Class(Sao.field.Field, {
    _default: null,
    get_client: function(record) {
...
Sao.field.DateTime = Class(Sao.field.Field, {
    _default: null
});

Sao.field.Date = Class(Sao.field.Field, {
    _default: null
});

Sao.field.Time = Class(Sao.field.Field, {
});

Sao.field.Number = Class(Sao.field.Field, {
    _default: null,
    get: function(record) {
...
Sao.field.Float = Class(Sao.field.Number, {
    set_client: function(record, value) {
        if (typeof value == 'string') {
            var value = Number(value); // without new for type conversion
            if (value == NaN) {
                value = this._default;
            }
        }
...
Sao.field.Numeric = Class(Sao.field.Number, {
    set_client: function(record, value) {
        if (typeof value == 'string') {
            var value = new Number(value); // with new to get an instance
            if (value.valueOf() == NaN) {
                value = this._default;
            }
        }
        Sao.field.Float._super.set_client.call(this, record, value);
...
Sao.field.Integer = Class(Sao.field.Number, {
    set_client: function(record, value) {
        if (typeof value == 'string') {
...
Sao.field.Boolean = Class(Sao.field.Field, {
    _default: false,
    set_client: function(record, value) {
        value = Boolean(value);
...
Sao.field.Many2One = Class(Sao.field.Field, {
    _default: null,
    get: function(record) {
        var value = record._values[this.name];
        // TODO force parent
...
Sao.field.One2One = Class(Sao.field.Many2One, {
});

Sao.field.One2Many = Class(Sao.field.Field, {
    init: function(description) {
    ...
    get: function(record) {
        ...
        for (var i = 0, len = group.length; i < len; i++) {
            ...
            if (record2.id >= 0) {
                var values = record2.get();
                delete values[parent_name];
                if (record2.has_changed() && !jQuery.isEmptyObject(values)) {
    ...
    set_default: function(record, value) {
        ...
        if ((value instanceof Array) && !isNaN(parseInt(value[0]))) {
            this.set(record, value);
            record._changed[this.name] = true;
            return;
        }
        ...
        var set_value = function(fields) {
            ...
            for (var val in value) {
                ...
                var new_record = group.new(false);
...
Sao.field.Many2Many = Class(Sao.field.One2Many, {
    set: function(record, value) {
        var group = record._values[this.name];
        var fields = {};
        if (group != undefined) {
