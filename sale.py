...
class SaleLine(OSV):
    ...
    def _view_look_dom_arch(self, cursor, user, tree, type, context=None):
        ...
        arch, fields, = super(SaleLine, self)._view_look_dom_arch(cursor,
    ...
    def fields_get(self, cursor, user, fields_names=None, context=None):
        ...
        res = super(SaleLine, self).fields_get(cursor, user, fields_names,
                context=context)

        analytic_accounts_field = super(SaleLine, self).fields_get(cursor,
    ...
    def _read_flat(self, cursor, user, ids, fields_names, context=None,
        ...
        res = super(SaleLine, self)._read_flat(cursor, user, ids, fields_names,
    ...
    def create(self, cursor, user, vals, context=None):
        ...
        return super(SaleLine, self).create(cursor, user, vals,
                context=context)
    ...
    def write(self, cursor, user, ids, vals, context=None):
        ...
        return super(SaleLine, self).write(cursor, user, ids, vals,
                context=context)
    ...
    def delete(self, cursor, user, ids, context=None):
        ...
        res = super(SaleLine, self).delete(cursor, user, ids,
                context=context)
    ...
    def copy(self, cursor, user, ids, default=None, context=None):
        ...
        new_ids = super(SaleLine, self).copy(cursor, user, ids,
