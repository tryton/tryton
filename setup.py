...
tests_require = [get_require_version('stock_package')]
dependency_links = []
if minor_version % 2:
...
setup(name=name,
    ...
    packages=[
        ...
        'trytond.modules.stock_shipment_measurements.tests',
        ],
    package_data={
        'trytond.modules.stock_shipment_measurements': (info.get('xml', [])
