...
if minor_version % 2:
    ...
    dependency_links.append('https://trydevpi.tryton.org/%s.%s'
        % (major_version, minor_version))
...
setup(name=name,
    ...
    packages=[
        ...
        'trytond.modules.sale_shipment_tolerance.tests',
        ],
    package_data={
        'trytond.modules.sale_shipment_tolerance': (info.get('xml', [])
    ...
    convert_2to3_doctests=[
        'tests/scenario_sale_shipment_tolerance.rst',
        ],
    )
