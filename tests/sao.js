...
QUnit.test('PYSON.Eval', function() {
    var value = new Sao.PYSON.Eval('test').pyson();
    ...
    var value = new Sao.PYSON.Eval('test', 'foo').pyson();
    QUnit.strictEqual(value.__class__, 'Eval', "Eval('test', 'foo').pyson()");
    ...
    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Eval('test', 0));
...
QUnit.test('PYSON Not', function() {
    ...
    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Not(true));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
        'decode(Not(true))');
    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Not(false));
...
QUnit.test('PYSON Bool', function() {
    ...
    QUnit.ok(SaoTest.compare(new Sao.PYSON.Bool('test').types(), ['boolean']),
        "Bool('test').types()");

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Bool(true));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), true,
        'decode(Bool(true))');

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Bool(false));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
        'decode(Bool(false))');

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Bool('test'));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), true,
        "decode(Bool('test'))");

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Bool(''));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
        "decode(Bool(''))");

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Bool(1));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), true,
        'decode(Bool(1))');

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Bool(0));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
        'decode(Bool(0))');
...
QUnit.test('PYSON Greater', function() {
    ...
    QUnit.ok(SaoTest.compare(new Sao.PYSON.Greater(1, 0).types(), ['boolean']),
        'Greater(1, 0).types()');

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Greater(1, 0));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), true,
            'decode(Greater(1, 0))');

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Greater(0, 1));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
            'decode(Greater(0, 1))');
    ...
    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Greater(1, 1));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
            'decode(Greater(1, 1))');
...
QUnit.test('PYSON Less', function() {
    ...
    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Less(1, 0));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
            'decode(Less(1, 0))');

    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Less(0, 1));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), true,
            'decode(Less(0, 1))');
    ...
    var eval_ = new Sao.PYSON.Encoder().encode(new Sao.PYSON.Less(1, 1));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_), false,
            'decode(Less(1, 1))');
...
QUnit.test('PYSON Get', function() {
    ...
    QUnit.ok(SaoTest.compare(new Sao.PYSON.Get({}, 'foo', 'default').types(),
...
QUnit.test('PYSON In', function() {
    ...
    QUnit.ok(SaoTest.compare(new Sao.PYSON.In('foo', {}).types(), ['boolean']),
        "In('foo', {}).types()");
...
QUnit.test('PYSON DateTime', function() {
    ...
    QUnit.strictEqual(value.__class__, 'DateTime',
        'Date(2010, 1, 12, 10, 30, 20, 0, -1, 12, -7, 2, 15, 30, 1).pyson()');
    QUnit.strictEqual(value.y, 2010,
        'Date(2010, 1, 12, 10, 30, 20, 0, -1, 12, -7, 2, 15, 30, 1).pyson()');
    QUnit.strictEqual(value.M, 1,
        'Date(2010, 1, 12, 10, 30, 20, 0, -1, 12, -7, 2, 15, 30, 1).pyson()');
    ...
    var eval_ = new Sao.PYSON.Encoder().encode(
            new Sao.PYSON.DateTime(2010, 1, 12, 10, 30, 20, 0, 0, 0, 0, 12));
    QUnit.strictEqual(new Sao.PYSON.Decoder().decode(eval_).valueOf(),
