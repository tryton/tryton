...
class GoogleMapsTestCase(unittest.TestCase):
    ...
    def test0005views(self):
        ...
        Test views.
        '''
        self.assertRaises(Exception, test_view('google_maps'))

def suite():
    return unittest.TestLoader().loadTestsFromTestCase(GoogleMapsTestCase)

if __name__ == '__main__':
    suiteTrytond = trytond.tests.test_tryton.suite()
    suiteGoogleMaps = suite()
    alltests = unittest.TestSuite([suiteTrytond, suiteGoogleMaps])
