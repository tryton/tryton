...
def suite():
    return unittest.TestLoader().loadTestsFromTestCase(AnalyticPurchaseTestCase)

if __name__ == '__main__':
    suiteTrytond = trytond.tests.test_tryton.suite()
    suiteAnalyticPurchase = suite()
    alltests = unittest.TestSuite([suiteTrytond, suiteAnalyticPurchase])
