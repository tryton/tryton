...
class CurrencyTestCase(unittest.TestCase):
    ...
    def get_currency(self, code):
        return self.currency.search(self.cursor, USER, [
                ('code', '=', code),
                ], 0, 1, None, CONTEXT)[0]
    ...
    def test0010currencies(self):
        ...
        Create currencies
        '''
        cu1_id = self.currency.create(self.cursor, USER, {
            'name': 'cu1',
            'symbol': 'cu1',
            'code': 'cu1'
            }, CONTEXT)
        self.assert_(cu1_id)
        cu2_id = self.currency.create(self.cursor, USER, {
            'name': 'cu2',
            'symbol': 'cu2',
            'code': 'cu2'
            }, CONTEXT)
    ...
    def test0020mon_grouping(self):
        ...
        self.assertRaises(Exception, self.currency.write, self.cursor, USER,
    ...
    def test0030rate(self):
        ...
        rate1 = Decimal("1.3")
        rate1_id = self.rate.create(self.cursor, USER, {
            'rate': rate1,
            'currency': cu1_id,
            }, CONTEXT)
        ...
        self.assertEqual(rate1, self.currency.read(self.cursor, USER,
    ...
    def test0050compute_simple(self):
        ...
        amount = Decimal("10")
        expected = Decimal("13")
        converted_amount = self.currency.compute(self.cursor, USER,
