...
.. seealso::
   ...
   Account move lines can be found by opening the main menu item:

      |Financial --> Entries --> Lines|__

      .. |Financial --> Entries --> Lines| replace:: :menuselection:`Financial --> Entries --> Lines`
      __ https://demo.tryton.org/model/account.move.line
