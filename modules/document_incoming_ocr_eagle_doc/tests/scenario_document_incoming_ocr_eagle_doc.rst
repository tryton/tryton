========================================
Document Incoming OCR Eagle Doc Scenario
========================================
...
Activate modules::
    ...
    ...     'document_incoming_ocr_eagle_doc',
...
Setup Typless service::
    ...
    >>> ocr_service = OCRService(type='eagle_doc')
    >>> ocr_service.eagle_doc_api_key = os.getenv('EAGLE_DOC_API_KEY')
    >>> ocr_service.eagle_doc_endpoint = 'invoice'
    >>> ocr_service.document_type = 'supplier_invoice'
    >>> ocr_service.save()
