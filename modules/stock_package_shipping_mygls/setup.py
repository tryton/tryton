...
setup(name=name,
    ...
    package_data={
        'trytond.modules.stock_package_shipping_mygls': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    stock_package_shipping_mygls = trytond.modules.stock_package_shipping_mygls
    """,  # noqa: E501
    )
