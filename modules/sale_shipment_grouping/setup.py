...
download_url = 'http://dowloads.tryton.org/%s.%s/' % (
...
setup(name=name,
    ...
    packages=(
        ...
        ['trytond.modules.sale_shipment_grouping.%s' % p for p in find_packages()]
        ),
    package_data={
    ...
    entry_points="""
    [trytond.modules]
    sale_shipment_grouping = trytond.modules.sale_shipment_grouping
    """,
    test_suite='tests',
