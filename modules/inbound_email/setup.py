...
setup(name=name,
    version=version,
    description='Tryton module to manage inbound email',
    ...
    packages=(
        ...
        + ['trytond.modules.inbound_email.%s' % p
            for p in find_packages()]
        ),
    package_data={
        'trytond.modules.inbound_email': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    inbound_email = trytond.modules.inbound_email
    """,  # noqa: E501
    )
