...
setup(name=name,
    ...
    packages=(
        ['trytond.modules.document_incoming_ocr_typless']
        + ['trytond.modules.document_incoming_ocr_typless.%s' % p
            for p in find_packages()]
        ),
    package_data={
        'trytond.modules.document_incoming_ocr_typless': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    document_incoming_ocr_typless = trytond.modules.document_incoming_ocr_typless
    """,  # noqa: E501
    )
