...
def suite():
    return unittest.TestLoader().loadTestsFromTestCase(SalePriceListTestCase)

if __name__ == '__main__':
    suiteTrytond = trytond.tests.test_tryton.suite()
    suiteSalePriceList = suite()
    alltests = unittest.TestSuite([suiteTrytond, suiteSalePriceList])
