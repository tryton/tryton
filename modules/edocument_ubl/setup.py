...
setup(name=name,
    ...
    project_urls={
        ...
        "Documentation": (
            'https://docs.tryton.org/latest/modules-edocument-ubl'),
        "Forum": 'https://www.tryton.org/forum',
        "Source Code": 'https://code.tryton.org/tryton',
        },
    keywords='tryton electronic document UBL',
    package_dir={'trytond.modules.edocument_ubl': '.'},
    packages=(
        ['trytond.modules.edocument_ubl']
        + ['trytond.modules.edocument_ubl.%s' % p
    ...
    entry_points="""
    [trytond.modules]
    edocument_ubl = trytond.modules.edocument_ubl
    """,  # noqa: E501
    )
