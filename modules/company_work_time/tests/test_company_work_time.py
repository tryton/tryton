...
class CompanyWorkTimeTestCase(unittest.TestCase):
    ...
    def test0005views(self):
        ...
        Test views.
        '''
        self.assertRaises(Exception, test_view('company_work_time'))

def suite():
    return unittest.TestLoader().loadTestsFromTestCase(CompanyWorkTimeTestCase)

if __name__ == '__main__':
    suiteTrytond = trytond.tests.test_tryton.suite()
    suiteCompanyWorkTime = suite()
    alltests = unittest.TestSuite([suiteTrytond, suiteCompanyWorkTime])
