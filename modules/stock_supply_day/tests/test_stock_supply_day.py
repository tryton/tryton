...
def suite():
    return unittest.TestLoader().loadTestsFromTestCase(StockSupplyDayTestCase)

if __name__ == '__main__':
    suiteTrytond = trytond.tests.test_tryton.suite()
    suiteStockSupplyDay = suite()
    alltests = unittest.TestSuite([suiteTrytond, suiteStockSupplyDay])
