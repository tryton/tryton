...
name = 'trytond_party_communication'
...
tests_require = [
    ...
    get_require_version('trytond_sale_complaint'),
...
setup(name=name,
    version=version,
    description='Tryton module for managing party communication',
    ...
    project_urls={
        ...
        "Documentation": 'https://docs.tryton.org/projects/modules-party-communication',  # noqa: E501
        "Forum": 'https://www.tryton.org/forum',
        "Source Code": 'https://code.tryton.org/tryton',
        },
    keywords='tryton party communication event',
    package_dir={'trytond.modules.party_communication': '.'},
    packages=(
        ['trytond.modules.party_communication']
        + ['trytond.modules.party_communication.%s' % p
