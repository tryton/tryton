...
.. glossary::
    ...
    `Server </projects/server/en/4.8>`_
        The main application.

    `Desktop Client </projects/client-desktop/en/4.8>`_
        The application to connect to the server.

    `Scripting Client </projects/client-library/en/4.8>`_
...
.. glossary::
    ...
    `Sale Subscription </projects/modules-sale-subscription/en/4.8>`
        Subscribes to recurring service.

    :ref:`Stock <index-stock>`
        Tracks goods in your warehouses.

    `Timesheet </projects/modules-timesheet/en/4.8>`_
        Tracks time spend.


    `Banking </projects/modules-bank/en/4.8>`_
    ...
    `Country </projects/modules-country/en/4.8>`_
        ISO 3166 list of countries and subdivisions.

    `Currency </projects/modules-currency/en/4.8>`_
        ISO 4217 list of currencies.

    `Customs </projects/modules-customs/en/4.8>`_
        Defines customs duty per tariff code.

    `Google Maps </projects/modules-google-maps/en/4.8>`_
    ...
    `Notification Email </projects/modules-notification-email/en/4.8>`_
        Sends email.

    `Web User </projects/modules-web-user/en/4.8>`_
